...
def try_to_process_verification(request, token)->tuple[bool, str, int]:
...
def all_phone_and_messages(request):
    ...
    phone_and_messages_dict = {phone:"\n\n".join(list_of_messages) for phone,list_of_messages in phone_and_messages_dict.items()}
